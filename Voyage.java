...
class Transport extends OptionVoyage{
	...
	public Transport (String nom,double prix,boolean trajet) {
		super(nom,prix);
		this.trajet=trajet;
	}
...
class Sejour extends OptionVoyage{
	...
	public Sejour(String nom,double prix,int nbrNuits,double prixNuit){
	...
	public double prix(){
		return (nbrNuits*prixNuit+super.prix());
	}
...
class KitVoyage {
	...
	public String toString(){
		...
		return str+"Prix total : "+prix()+" CHF\n";
